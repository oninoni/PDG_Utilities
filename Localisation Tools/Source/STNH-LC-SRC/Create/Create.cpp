// Create.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	std::vector<std::pair<std::string, std::string>> filenames = {
		...
		{ "ST New Horizons - Modifiers Localisation.json", "localisation\\<lang>\\STH_modifiers_l_<lang>.yml" },
